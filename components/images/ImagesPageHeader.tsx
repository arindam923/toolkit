import { IMAGE_PAGE_STATS } from "@/data/images";

export default function ImagesPageHeader() {
  return (
    <section
    ...
    >
      ...
      <div className="relative">
        ...
        >
          Resize, compress, convert, crop, remove backgrounds, and enhance images
          with our comprehensive image processing tools.
        </p>
