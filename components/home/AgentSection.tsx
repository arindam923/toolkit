        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-2 py-1 border border-brand-accent/30 bg-brand-accent/5 rounded">
              ...
              <span className="mono-label text-brand-accent">In Development</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter leading-none">
              BUILT FOR AGENTS.
              <br />
              <span className="text-muted-foreground/40">COMING TO MCP.</span>
            </h2>
            <p className="text-muted-foreground text-sm uppercase tracking-widest leading-relaxed max-w-md">
              Toolkit is more than a UI. Every utility is being exposed via the
              Model Context Protocol (MCP), so AI agents can run real image and
              PDF operations locally with zero latency.
            </p>
            <div className="flex gap-4">
              <span className="mono-label px-6 py-3 border border-border text-muted-foreground">
          ...
          <div className="relative">
            <div className="bg-background border border-border p-6 font-mono text-[11px] leading-relaxed shadow-2xl overflow-x-auto">
              <div className="flex items-center justify-between mb-4 border-b border-border pb-2 min-w-[240px]">
                <span className="text-muted-foreground">toolkit_mcp_config.json</span>
              ...
              <div className="space-y-1">
                ...
                <div className="pl-4">
                  <span className="text-brand-accent">{'"mcpServers"'}</span>: {"{"}
                </div>
                <div className="pl-8">
                  <span className="text-brand-accent">{'"toolkit"'}</span>: {"{"}
                </div>
                <div className="pl-12">
                  <span className="text-brand-accent">{'"command"'}</span>:{" "}
                  <span className="text-blue-400">{'"node"'}</span>,
                </div>
                <div className="pl-12">
                  <span className="text-brand-accent">{'"args"'}</span>:{" "}
                  <span className="text-muted-foreground">
                    {/* placeholder until the server ships */}
                    {['"toolkit-mcp-server/dist/index.js"']}
                  </span>
                </div>
                ...
                <div className="pt-2 text-muted-foreground/60">
                  {"// Coming soon — watch the repo for the server release."}
                </div>
              </div>
            </div>
