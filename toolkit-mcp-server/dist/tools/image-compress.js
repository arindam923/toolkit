...
export const ImageCompressSchema = z
    ...
    preset: z
        ...
        .optional()
        .describe("Compression preset: web_optimized (80% quality, WebP, max 1200w), email (60%, max 800w), social_media (85%, max 1080w), thumbnail (70%, max 300w)"),
})
    .strict();
export async function imageCompress(params) {
    ...
    const outputFormat = format ?? inputMeta.format;
    ...
    const outputPath = params.output_path
        ? params.output_path
        : defaultOutputPath(params.input_path, "compressed").replace(/\.[^.]+$/, ext);
